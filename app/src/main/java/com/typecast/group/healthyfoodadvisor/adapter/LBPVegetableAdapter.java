...
/**
 * Created by pt on 5/7/16.
 */
public class LBPVegetableAdapter extends RecyclerView.Adapter<LBPVegetableAdapter.ViewHolder> {
    Context mContext;
    OnItemClickListener mItemClickListener;
    // 2
    public LBPVegetableAdapter(Context context) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        final FoodItem foodItem = new FoodItemData().lbpVegetableList().get(position);
    ...
    public int getItemCount() {
        return new FoodItemData().lbpVegetableList().size();
    }
