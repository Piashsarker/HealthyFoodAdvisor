...
import com.typecast.group.healthyfoodadvisor.model.FoodCategory;
import com.typecast.group.healthyfoodadvisor.model.FoodCategoryData;
...
public class FoodCategoryAdapter extends RecyclerView.Adapter<FoodCategoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        final FoodCategory foodCategory = new FoodCategoryData().foodCategoryList().get(position);
        holder.placeName.setText(foodCategory.name);
        Picasso.with(mContext).load(foodCategory.getImageResourceId(mContext)).into(holder.placeImage);

        Bitmap photo = BitmapFactory.decodeResource(mContext.getResources(), foodCategory.getImageResourceId(mContext));
    ...
    public int getItemCount() {
        return new FoodCategoryData().foodCategoryList().size();
    }
