 ...
 */
public class LBPOtherAdapter extends RecyclerView.Adapter<LBPOtherAdapter.ViewHolder> {
    Context mContext;
    OnItemClickListener mItemClickListener;
    // 2
    public LBPOtherAdapter(Context context) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        final FoodItem foodItem = new FoodItemData().lbpOtherList().get(position);
    ...
    public int getItemCount() {
        return new FoodItemData().lbpOtherList().size();
    }
