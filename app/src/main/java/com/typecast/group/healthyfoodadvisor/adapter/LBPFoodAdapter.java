 ...
 */
public class LBPFoodAdapter extends RecyclerView.Adapter<LBPFoodAdapter.ViewHolder> {
    Context mContext;
    OnItemClickListener mItemClickListener;
    // 2
    public LBPFoodAdapter(Context context) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        final FoodItem foodItem = new FoodItemData().lbpFoodList().get(position);
    ...
    public int getItemCount() {
        return new FoodItemData().lbpFoodList().size();
    }
