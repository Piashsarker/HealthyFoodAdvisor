 ...
 */
public class HBPFruitAdapter extends RecyclerView.Adapter<HBPFruitAdapter.ViewHolder> {
    Context mContext;
    OnItemClickListener mItemClickListener;
    // 2
    public HBPFruitAdapter(Context context) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        final FoodItem foodItem = new FoodItemData().hbpFruitList().get(position);
    ...
    public int getItemCount() {
        return new FoodItemData().hbpFruitList().size();
    }
