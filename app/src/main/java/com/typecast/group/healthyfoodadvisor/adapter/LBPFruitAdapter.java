 ...
 */
public class LBPFruitAdapter extends RecyclerView.Adapter<LBPFruitAdapter.ViewHolder> {
    Context mContext;
    OnItemClickListener mItemClickListener;
    // 2
    public LBPFruitAdapter(Context context) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        final FoodItem foodItem = new FoodItemData().lbpFruitList().get(position);
    ...
    public int getItemCount() {
        return new FoodItemData().lbpFruitList().size();
    }
